...
const topDiv= document.querySelector('.scrollTop').addEventListener('click',()=>{
    window.scrollTo({
        top:0 ,
        behavior: 'smooth'
    })
...
let loadMoreBtn = document.querySelector('.loadMore').addEventListener('click' , async ()=>{
